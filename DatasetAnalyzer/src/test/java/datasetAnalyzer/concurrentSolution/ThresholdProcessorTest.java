package datasetAnalyzer.concurrentSolution;

import datasetAnalyzer.sequentialSolution.CsvFileReader;
import java.io.File;
...
class ThresholdProcessorTest {
  ...
  void setUp() {
    File testDirectory = new File(
        "src" + File.separator + "test" + File.separator + "java" + File.separator + "datasetAnalyzer"
